...
func CheckStatus(appId string, appSecret string, api string, phoneNubmber string) (bool, string) {
	...
	log.Printf("%v: %v, %v", phoneNubmber, content.Resources[0].Active, content.Resources[0].UserName)
	return content.Resources[0].Active, content.Resources[0].UserName
}
